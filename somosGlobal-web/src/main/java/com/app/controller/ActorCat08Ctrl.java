...
@SessionScoped
@ManagedBean
public class ActorCat08Ctrl extends Controladores {
	private String catIdSeleccionada = "08";
	...
	public void recuperarLocalVentaList3() {
		...
		actorList = findAllActores(palabraClaveAct, "08");
		if (actorList.size() == 0) {
	...
	private List<Actor> findAllActores(String palabraClave, String catId) {
		List<Actor> actores = sActor.findAllByCategoriaInHijosFromRolNegocio(
				rolNegocio, catId, Globales.EST_OK, Globales.EST_OK,
				palabraClave);
